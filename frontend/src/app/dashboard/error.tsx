// This component implements the error fallback page for the dashboard, providing reset triggers for error recovery.
"use client";
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 text-slate-100 font-sans">
      <div className="max-w-md w-full text-center space-y-6 bg-slate-900/60 border border-slate-900 p-8 rounded-2xl shadow-xl">
        ...
        <p className="text-slate-400 text-sm leading-relaxed">
          The dashboard metrics or analytics charts encountered an error while loading.
        </p>
